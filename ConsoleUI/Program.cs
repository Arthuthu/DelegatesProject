...
namespace ConsoleUI
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The total for the cart is {cart.GenerateTotal(SubTotalAlert, CalculateLeveledDiscount, TellUserWeAreDiscouting):C2}");
            Console.WriteLine();
            decimal total = cart.GenerateTotal((subTotal) => Console.WriteLine($"The subtotal for cart 2 is {subTotal:C2}"),
                ...
                (alertUser) => Console.WriteLine(alertUser));
        ...
        private static void TellUserWeAreDiscouting(string mention)
        {
            Console.WriteLine();
        }
